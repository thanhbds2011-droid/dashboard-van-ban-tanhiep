/** Production - Evaluation Period Read Service (read only). */
...
export const PeriodReadService = Object.freeze({
  ...
  active(periods = []) {
    return periods.find(item => item.active === true || ["ACTIVE", "OPEN", "IN_PROGRESS", "ASSESSMENT", "REPORTING"].includes(item._status)) || null;
  }
});
