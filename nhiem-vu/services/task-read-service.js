...
import { taskAcceptanceState } from "../core/task-display-order.js?v=20260916.V1_24_5";
...
function scopedReferences(periodId) {
  ...
  if (Permissions.canViewAllDepartments()) {
    ...
    /*
     * V1.22.2: lãnh đạo TCHC có quyền xem toàn phạm vi chuyên môn nên đi vào nhánh này
