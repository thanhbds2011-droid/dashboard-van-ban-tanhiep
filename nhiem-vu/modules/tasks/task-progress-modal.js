...
import { friendlyErrorMessage } from "../../core/friendly-error.js?v=20260904.V1_22_7";
import { ModalService } from "../../core/modal-service.js?v=20260904.V1_22_7";
import { TaskWriteService } from "../../services/task-write-service.js?v=20260904.V1_22_7";
import { TaskMilestoneService } from "../../services/task-milestone-service.js?v=20260904.V1_22_7";
import { DriveEvidenceService } from "../../services/drive-evidence-service.js?v=20260904.V1_22_7";
...
import { StagedEvidenceUploader } from "../../services/staged-evidence-uploader.js?v=20260904.V1_22_7";
import { validateProgressInput, cleanText } from "./task-form-validator.js?v=20260904.V1_22_7";
      ...
      try {
        if (completesMilestone) {
          ...
          if (closeResult?.earlyVerified) {
            console.info("EVENT_DRIVEN_CLOSE_CONFIRMED_EARLY", { taskId: task.id, taskCode: task.taskCode || "", build: "20260904.V1_22_7" });
          }
        } else {
