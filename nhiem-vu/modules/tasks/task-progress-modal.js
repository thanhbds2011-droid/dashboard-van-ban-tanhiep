...
import { DriveEvidenceService } from "../../services/drive-evidence-service.js?v=20260913.V1_23_2";
...
import { validateProgressInput, cleanText } from "./task-form-validator.js?v=20260913.V1_23_2";
      ...
      try {
        if (completesMilestone) {
          ...
          if (closeResult?.earlyVerified) {
            console.info("EVENT_DRIVEN_CLOSE_CONFIRMED_EARLY", { taskId: task.id, taskCode: task.taskCode || "", build: "20260913.V1_23_2" });
          }
        } else {
