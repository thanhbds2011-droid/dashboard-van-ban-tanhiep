...
import { DriveEvidenceService } from "../../services/drive-evidence-service.js?v=20260903.V1_22_5";
...
import { validateProgressInput, cleanText } from "./task-form-validator.js?v=20260903.V1_22_5";
      ...
      try {
        if (completesMilestone) {
          ...
          if (closeResult?.earlyVerified) {
            console.info("EVENT_DRIVEN_CLOSE_CONFIRMED_EARLY", { taskId: task.id, taskCode: task.taskCode || "", build: "20260903.V1_22_5" });
          }
        } else {
