...
import { DriveEvidenceService } from "../../services/drive-evidence-service.js?v=20260904.V1_23_0";
...
import { validateProgressInput, cleanText } from "./task-form-validator.js?v=20260904.V1_23_0";
      ...
      try {
        if (completesMilestone) {
          ...
          if (closeResult?.earlyVerified) {
            console.info("EVENT_DRIVEN_CLOSE_CONFIRMED_EARLY", { taskId: task.id, taskCode: task.taskCode || "", build: "20260904.V1_23_0" });
          }
        } else {
