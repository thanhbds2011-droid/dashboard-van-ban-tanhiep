...
import { Router } from "./core/router.js?v=20260916.V1_24_7";
import { APP_VERSION_LABEL, BUILD_VERSION } from "./core/app-version.js?v=20260916.V1_24_7";
import { AuthService } from "./core/auth-service.js?v=20260916.V1_24_7";
...
const renderDashboardView = lazyRoute("./modules/dashboard/dashboard-view.js?v=20260916.V1_24_7", "renderDashboardView");
const renderExecutiveDirectivesView = lazyRoute("./modules/executive-directives/executive-directives-view.js?v=20260916.V1_24_7", "renderExecutiveDirectivesView");
const renderTasksView = lazyRoute("./modules/tasks/tasks-view.js?v=20260916.V1_24_7", "renderTasksView");
const renderStandardTasksView = lazyRoute("./modules/standard-tasks/standard-tasks-view.js?v=20260916.V1_24_7", "renderStandardTasksView");
const renderPeriodsView = lazyRoute("./modules/periods/periods-view.js?v=20260916.V1_24_7", "renderPeriodsView");
const renderPlansView = lazyRoute("./modules/plans/plans-view.js?v=20260916.V1_24_7", "renderPlansView");
const renderEvaluationsView = lazyRoute("./modules/evaluations/evaluations-view.js?v=20260916.V1_24_7", "renderEvaluationsView");
const renderReportsView = lazyRoute("./modules/reports/reports-view.js?v=20260916.V1_24_7", "renderReportsView");
const renderAdminView = lazyRoute("./modules/admin/admin-view.js?v=20260916.V1_24_7", "renderAdminView");
