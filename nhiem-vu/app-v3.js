...
import { Router } from "./core/router.js?v=20260902.V1_22_0";
import { APP_VERSION_LABEL, BUILD_VERSION } from "./core/app-version.js?v=20260902.V1_22_0";
import { AuthService } from "./core/auth-service.js?v=20260902.V1_22_0";
...
import { ExecutivePushSubscriptionService } from "./services/executive-push-subscription-service.js?v=20260902.V1_22_0";
import { ExecutiveInAppAlertService } from "./services/executive-in-app-alert-service.js?v=20260902.V1_22_0";
...
const renderDashboardView = lazyRoute("./modules/dashboard/dashboard-view.js?v=20260902.V1_22_0", "renderDashboardView");
const renderExecutiveDirectivesView = lazyRoute("./modules/executive-directives/executive-directives-view.js?v=20260902.V1_22_0", "renderExecutiveDirectivesView");
const renderTasksView = lazyRoute("./modules/tasks/tasks-view.js?v=20260902.V1_22_0", "renderTasksView");
const renderStandardTasksView = lazyRoute("./modules/standard-tasks/standard-tasks-view.js?v=20260902.V1_22_0", "renderStandardTasksView");
const renderPeriodsView = lazyRoute("./modules/periods/periods-view.js?v=20260902.V1_22_0", "renderPeriodsView");
const renderPlansView = lazyRoute("./modules/plans/plans-view.js?v=20260902.V1_22_0", "renderPlansView");
const renderEvaluationsView = lazyRoute("./modules/evaluations/evaluations-view.js?v=20260902.V1_22_0", "renderEvaluationsView");
const renderReportsView = lazyRoute("./modules/reports/reports-view.js?v=20260902.V1_22_0", "renderReportsView");
const renderAdminView = lazyRoute("./modules/admin/admin-view.js?v=20260902.V1_22_0", "renderAdminView");
