...
import { TaskNotificationBridge } from "./services/task-notification-bridge.js?v=20260809.V1_10_2";
import {
  openTchcCouncilManager,
  openDepartmentCouncilManager,
  openMyCouncilAdjustments,
  openCouncilReport
} from "./modules/kpi/council-adjustment-ui.js?v=20260809.V1_10_2";

const BUILD = "20260809.V1_10_2";
let observer = null;
let scheduled = false;
