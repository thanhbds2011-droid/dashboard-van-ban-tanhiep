...
const addDoc=()=>{}, collection=()=>{}, deleteDoc=()=>{}, doc=()=>{}, getDoc=()=>{}, getDocs=()=>{}, onSnapshot=()=>{}, query=()=>{}, serverTimestamp=()=>{}, setDoc=()=>{}, updateDoc=()=>{}, where=()=>{};
const TaskRegistrationService={};
const KPI2C={}, COMMON_CRITERIA=[]; const calculateTaskScore=()=>({}), calculateKpiSummary=()=>({A:0,B:0,kpi70:0,common30:0,total100:0}), proposedRating=()=>'', ratingName=()=>'', round2=x=>x, progressRateFromDates=()=>100;
